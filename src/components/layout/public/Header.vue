   ...
   <!-- BEGIN | Header -->
        ...
        <div class="container">
            <nav class="navbar navbar-default navbar-custom">
                    ...
                    <div class="navbar-header logo">
                        ...
                        <a href="index.html"><img class="logo" src="/static/images/logo3.png" alt="" width="119" height="58"></a>
                    </div>
            ...
            <div class="top-search">
                ...
                <input type="text" v-model="querySearch" @input="queryData" placeholder="Search for a movie">
            </div>
    ...
    <div class="resultSearch" v-if="queryResult.length > 0">
        ...
        <div v-if="typeSearch=='movie'" class="result-movie">
            <router-link tag="div" :to="{name: 'MovieElements', params: {id: result.movie_id }}" class="resultItem" v-for="(result, index) in queryResult" :key="index" >
...
import SignUp from '@/components/layout/public/SignUp'
...
export default {
    ...
    // Listening the event hello
        ...
        this.$store.dispatch("getEveryMovie");
    },
    computed: {
        isLoggedIn () {
            let isLoggedIn;
    ...
    methods: {
        logout: function() {
            firebase
                ...
                if(this.$route.path === "/user/account" || this.$route.path === "/user/myreviews" || this.$route.path === "/ticket"
                || this.$route.path === "/user/purchases") this.$router.push('/')
            })
        },
        queryData() {
