<template>
				...
				<div class="movie-img sticky-sb">
					...
					<div class="movie-btn">	
						...
						<div class="btn-transform transform-vertical">
							...
							<div><a  @click="handleMovieTime" class="item item-2 yellowbtn"><i class="ion-card"></i></a></div>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="social-btn">
						...
						<div class="hover-bnt">
							...
							<div class="hvr-item">
								...
								<a href="https://reddit.com" class="hvr-grow"><i class="ion-social-reddit"></i></a>
								<a href="https://youtube.com" class="hvr-grow"><i class="ion-social-youtube"></i></a>
							</div>
						</div>		
					</div>
													...
													<div id="overview" class="tab active">
														<div class="row">
															...
															<div class="col-md-4 col-xs-12 col-sm-12">
																...
																<div class="sb-it">
																	<h6>Release Date:</h6>
																	<p>{{ currentMovie[0].releaseDate }}</p>
																</div>
																<div class="sb-it">
																	<h6>Run Time:</h6>
																	<p>{{ currentMovie[0].runTime }}</p>
																</div>
																<div class="sb-it">
																	<h6>MMPA Rating:</h6>
																	<p>{{ currentMovie[0].MMPRating }}</p>
																</div>
															</div>
														</div>	
													</div>
	...
	<appMovieTime v-if="showMovieTime" @closeMovieTime="showMovieTime = false"/>
    </div>
</template>
...
import TrailerModal from '@/components/layout/public/ModalTrailer.vue'
import ReviewModal from '@/components/layout/public/ModalReview.vue'
import MovieTime from '@/components/layout/Movies/MovieTime.vue'
import Pagination from '@/components/layout/public/Pagination.vue'
export default {
    data: function () {
      return {
		index: null,
    ...
    methods: {
		...
		fetchAllReview() {
            this.$store.dispatch("getEveryReview").then(() => {
            })
		},
		fetchCurrentReviews() {
		...
		handleMovieTime() {
			if(this.currentUser) this.showMovieTime = true;
			else {
				this.$swal({
					title: 'Warning !',
