            ...
            <div class="hero user-hero">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="hero-ct">
                                <h1>{{ currentUser.displayName ? currentUser.displayName :  currentUser.email }}'s account</h1>
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12">
                            <div class="user-information">
                                ...
                                <div class="user-fav">
                                    <p>Account Details</p>
                                    <ul>
                                        <router-link active-class="active" tag="li" to="/user/account"><a>Account</a></router-link>
                                        <router-link active-class="active" tag="li" to="/user/myreviews"><a>My Rated Movie</a></router-link>
                                        <router-link active-class="active" tag="li" to="/user/purchases"><a>Purchase History</a></router-link>
                                    </ul>
                                </div>
    ...
    export default {
        data() {
            return {
                ...
                photoUrl: this.$store.getters.user.photoUrl ? this.$store.getters.user.photoUrl : "/static/images/uploads/profile-image.png"
            }
        },
        watch: {
            currentUser (value) {
